...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    scores = activated_hidden.dot(W2) + b2
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
    ...
    #############################################################################
    correctScores = np.zeros(p.shape)
    correctScores[np.arange(num_train), y] = 1
    dScores = p - correctScores
  ...
  def predict(self, X):
    ...
    ###########################################################################
    scores = np.max(0,(X.dot(self.params["W1"]) + self.params["b1"]))
